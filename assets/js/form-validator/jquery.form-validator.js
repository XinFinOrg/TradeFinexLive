...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    LANG: {
	  ...
	  badLinkedinUrl: 'The input value is not a correct Linkedin URL',
...
(function($) {
  ...
  $.formUtils.addValidator({
    ...
    validatorFunction: function (url) {
      ...
      var urlFilter = /^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i;
 ...
 /*
  ...
  $.formUtils.addValidator({
    name: 'linkedin_url',
    validatorFunction: function (linkedin_url) {
      // written by Scott Gonzalez: http://projects.scottsplayground.com/iri/
      // - Victor Jonsson added support for arrays in the url ?arg[]=sdfsdf
      // - General improvements made by Stéphane Moureau <https://github.com/TraderStf>

      // var urlFilter = /^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?linkedin\.com\/in\/([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i;
  
	  var urlFilter =  /(http|https):\/\/?(?:www\.)?linkedin.com(\w+:{0,1}\w*@)?(\S+)(:([0-9])+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;
	  if (urlFilter.test(linkedin_url)) {
        var domain = linkedin_url.split('://')[1],
          domainSlashPos = domain.indexOf('/');
    ...
    errorMessage: '',
    errorMessageKey: 'badLinkedinUrl'
  });
  ...
  $.formUtils.addValidator({
    ...
    validatorFunction: function (val, $el, conf) {
      if (val !== '') {
		...
		if (allowing.indexOf('float') > -1 && val.match(new RegExp('^([0-9-]+)|([0-9-]+)\\.([0-9]+)$')) !== null) {
		  return true;
        }
      }
      return false;
