    ...
    <div class="modal fade" id="myModalP" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog supplier_area">
            ...
            <div class="modal-content">
                <?php
                $attributes = array('id' => 'form_financier_request', 'name' => 'form_financier_request', 'class' => '', 'method' => 'post', 'role' => 'form');
                                ...
                                <div class="panel-body">
                                    <form id="xinfinForm" class="" method="post" role="form" enctype="multipart/form-data" accept-charset="utf-8">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-12 no-padding-left xinfin_signin_error" style="display:none">
                                            <label class="error" style="color:red;width:100%;">XinFin Username/Password Not Valid ! Try again. <hr class="left" />	<small>New to XDC ? <a href="https://ewallet.xinfin.org/" class="create_account_xinfin" target="_blank"> Create account</a> </small><hr class="right" /></label>
                                        </div>
        ...
        <div class="row">
            <div class="jumbotron thank_sec" >
                <div id="page_blank_msg" class="bwhite_content">
                    <div class="gpopup_head"><a href="javascript:void(0)" onclick="window.location = '<?php echo base_url() ?>';
                                document.getElementById('page_blank_msg').style.display = 'none';"><i class="fa fa-times-circle" aria-hidden="true"></i></a></div>
                                                <?php
