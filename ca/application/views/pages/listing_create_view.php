                                        ...
                                        <div class="browse_file custom_fileup">
                                            ...
                                            <label id="namefile_1" class="namefile_1 browse_file_name"><!--[jpg,jpeg,png,doc,docx,xls,xlsx,pdf,txt]-->
                                                ...
                                                if (!empty($project_files) && isset($project_files[1]) && sizeof($project_files[1]) <> 0 && isset($project_files[1]->tppf_row_deleted) && $project_files[1]->tppf_row_deleted == 0) {
                                                    echo '<div> <a href="' . base_url() . 'assets/project_post_files/' . $project_files[1]->tppf_filename . '" target="_blank" title="Download file" ><i class="fa fa-download"></i>&nbsp;'. $project_files[1]->tppf_filename .'</a> <span style="cursor:pointer;font-size: 17px;" class="remove_project_file" fileid="' . $project_files[1]->tppf_id . '"> <i class="fa fa-times"></i></span></div>';
                                                }
                                                ?>
                                            </label>
                                            &nbsp;
                                            <label id="namefile_2" class="namefile_2 browse_file_name"><!--[jpg,jpeg,png,doc,docx,xls,xlsx,pdf,txt]-->
                                                <?php
                                                if (!empty($project_files) && isset($project_files[0]) && sizeof($project_files[0]) <> 0 && isset($project_files[0]->tppf_row_deleted) && $project_files[0]->tppf_row_deleted == 0) {
                                                    echo '<div> <a href="' . base_url() . 'assets/project_post_files/' . $project_files[0]->tppf_filename . '" target="_blank" title="Download file" ><i class="fa fa-download"></i>&nbsp;'. $project_files[0]->tppf_filename .'</a> <span style="cursor:pointer;font-size: 17px;" class="remove_project_file" fileid="' . $project_files[0]->tppf_id . '"> <i class="fa fa-times"></i></span></div>';
                                                }
                                                ?>


                                            </label>&nbsp;
                                                <label id="namefile_3" class="namefile_3 browse_file_name"><!--[jpg,jpeg,png,doc,docx,xls,xlsx,pdf,txt]-->
                                                    <?php
                                                if (!empty($project_files) && isset($project_files[2]) && sizeof($project_files[2]) <> 0 && isset($project_files[2]->tppf_row_deleted) && $project_files[2]->tppf_row_deleted == 0) {
                                                    echo '<div> <a href="' . base_url() . 'assets/project_post_files/' . $project_files[2]->tppf_filename . '" target="_blank" title="Download file" ><i class="fa fa-download"></i>&nbsp;'. $project_files[2]->tppf_filename .'</a> <span style="cursor:pointer;font-size: 17px;" class="remove_project_file" fileid="' . $project_files[2]->tppf_id . '"> <i class="fa fa-times"></i></span></div>';
                                                }
                                                ?>
                                ...
                                <div class="submit_form_sec project_image">
                                    ...
                                    <div class="contact_person_photo_back">
                                        <div class="contact_person_photo"> <span class="camera_icon"><img id="project_image" src="<?= ((isset($pimage) && trim($pimage) <> '') ? base_url('assets/images/projectsimg/' . $pimage) : base_url('assets/images/icon/camera.png')); ?>" alt="icon"></span>
                                            <label for="file-upload" class="custom-file-upload" onclick="document.getElementById('light').style.display = 'block';
                                                    document.getElementById('fade').style.display = 'block'"> <img src="<?= base_url() ?>assets/images/icon/upload_plus.png"> </label>
                                        </div>
...
<div id="light" class="white_content">
    <div class="gpopup_head"><a href="javascript:void(0)" onclick="document.getElementById('light').style.display = 'none';
            document.getElementById('fade').style.display = 'none'"><i class="fa fa-times-circle" aria-hidden="true"></i></a></div>
