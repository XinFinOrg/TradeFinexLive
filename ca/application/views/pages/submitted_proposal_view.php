                ...
                <div class="similar_area">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-12 payable_emi">
                            ...
                            <div class="common_style project_document" style="margin-top: 0">
                                <h4 style="margin-left:0px">Project Documents</h4>
                                    <div class="table-responsive">
                                                       ...
                                                       if($ruser_type == 1)
                                                       {
                                                        if ($proposal_files[$i]->tpssf_row_deleted == 0 ) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><a  target="_blank" href="<?= base_url('assets/project_proposals/' . $proposal_files[$i]->tpssf_filename); ?>"><i class="fa fa-download" aria-hidden="true"></i></a></td>
                                                            </tr>	
                                                        <?php
                                                        }
                                                       }
                                                       else if($ruser_type == 2)
                                                       {
                                                        if ($proposal_files[$i]->tpfsf_row_deleted == 0) {
                                                            ?>
                                                            <tr>
                                                                <td><?= $count; ?></td>
                                                                <td><?= 'Project Document ' . $count++; ?></td>
                                                                <td class="text-center"><a  target="_blank" href="<?= base_url('assets/project_proposals/' . $proposal_files[$i]->tpfsf_filename); ?>"><i class="fa fa-download" aria-hidden="true"></i></a></td>
                                                            </tr>	
                                                        <?php
                                                        }
                                                       }  
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 view_proposal_btn_area">
                            <div class="common_style">
                                <div class="project_related_btns">
                                    <?php
                                    if ($ruser_type == 1 && $project_listed_info[0]->awarded_provider == 3) {
                                        ...
                                        if ($peditmode == 0) {
                                            ...
                                            echo '<div class="decline_edit"><button type="button" class="decline_btn proposal_reject" user_type_ref="' . $putype_ref . '" prow_id="' . $prrow . '" user_id="' . $puser . '" row_id="' . $projref . '"><i class="fa fa-times" aria-hidden="true"></i> Decline</button></div>
						  <div class="decline_edit"><button type="button" class="edit_btn send_request_message" proj_id="' . $projref . '" user_id="' . $user_id . '" send_user="' . $puser . '" send_user_type="' . $putype_ref . '" title="Request to edit Proposal"><i class="fa fa-pencil" aria-hidden="true"></i> Request </button></div>';
                                        }
                                    ...
                                    else if ($user_type_ref == 3 && $peditmode == 0 && trim($special_request) <> '') {
    ...
    <div class="modal fade" id="myModalP" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog supplier_area">
            ...
            <div class="modal-content">
                <?php
                $attributes = array('id' => 'form_proposal_modify_request', 'name' => 'form_proposal_modify_request', 'class' => '', 'method' => 'post', 'role' => 'form');
