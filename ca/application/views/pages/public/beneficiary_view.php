		...
		<div class="row">
			<div class="first_icon_text">
				...
				<div class="col-md-7 col-sm-6 col-xs-12">
					...
					<p>While beneficiaries are looking to secure finance at globally competitive rates, the inefficiencies in traditional financial system increases cost of capital. XinFin’s marketplace platform, TradeFinex aims to minimize inefficiencies in trade and finance using Blockchain Technology. Powered by XinFin’s XDC01 protocol TradeFinex, a peer to peer contract platform, can be used with existing laws of the land and payment rails or in an approved jurisdiction using underlying XDC tokens.</p>
