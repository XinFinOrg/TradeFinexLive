			 ...
			 <div class="row">
				<div class="col-md-3 col-sm-4">
					<div id="filters" class="listing_drop_down_search"> <!-- modal fade  role="dialog" -->
						...
						<div class="panel-group listing_project_type" id="accordion">
										...
										<?php
											if($pcontracts && !empty($pcontracts) && is_array($pcontracts) && sizeof($pcontracts) <> 0){
												...
												foreach($pcontracts as $prow){
													...
													echo '<div class="form-group"><div class="checkbox checkbox-danger contract_type col_check" colname="contractID"><input id="contract-'.$prow->ID.'" type="checkbox" name="contract-'.$prow->ID.'" rowv="'.$prow->ID.'" class="search_project_post contracts" sval="'.$prow->ID.'" '.((isset($sconval) && !empty($sconval) && in_array($prow->ID, $sconval)) ? 'checked' : '').'><label for="contract-'.$prow->ID.'"> '.$prow->cName.' </label></div></div>';
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"> <a class="accordion-toggle <?=((!empty($scolumn) && in_array('mainCategoryId', $scolumn)) ? '' : 'collapsed') ?>" data-toggle="collapse" data-parent="#accordion" href="#collapsetwo">Industry</a> </h4>
								</div>
								<div id="collapsetwo" class="panel-collapse collapse <?=((!empty($scolumn) && in_array('mainCategoryId', $scolumn)) ? 'in' : '') ?>">
									<div class="panel-body">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"> <a class="accordion-toggle <?=((!empty($scolumn) && in_array('sectors', $scolumn)) ? '' : 'collapsed') ?>" data-toggle="collapse" data-parent="#accordion" href="#collapsethree">Sector</a> </h4>
								</div>
								<div id="collapsethree" class="panel-collapse collapse <?=((!empty($scolumn) && in_array('sectors', $scolumn)) ? 'in' : '') ?>">
									<div class="panel-body">
										<div class="listing_side-search_scroll">
											<?php
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"> <a class="accordion-toggle <?=((!empty($scolumn) && in_array('countryID', $scolumn)) ? '' : 'collapsed') ?>" data-toggle="collapse" data-parent="#accordion" href="#collapsefour">Country</a> </h4>
								</div>
								<div id="collapsefour" class="panel-collapse collapse <?=((!empty($scolumn) && in_array('countryID', $scolumn)) ? 'in' : '') ?>">
									<div class="panel-body">
										<div class="listing_side-search_scroll">
										<?php
											if($pcountries && !empty($pcountries) && is_array($pcountries) && sizeof($pcountries) <> 0){
												...
												foreach($pcountries as $prow){
													...
													echo '<div class="form-group"><div class="checkbox checkbox-danger country_ref col_check" colname="countryID"><input id="country-'.$prow->tfc_id.'" type="checkbox" name="country-'.$prow->tfc_id.'" rowv="'.$prow->tfc_id.'" class="search_project_post countries" sval="'.$prow->tfc_id.'" '.((isset($scountry) && !empty($scountry) && in_array($prow->tfc_id, $scountry)) ? 'checked' : '').'><label for="country-'.$prow->tfc_id.'"> '.$prow->tfc_name.' </label></div></div>';
				...
				<div class="col-md-9 col-sm-8 col-xs-12">
					<div class="listing_search_result">
						<div class="tab_group">
							<ul>
								<li class="all_projects <?=((isset($sort_order) && $sort_order <> '' && $sort_order == 'desc' && trim($type) == '') ? 'most_recent active' : ((isset($type) && $type == '') ? 'active' : ''));?>"><a href="javascript:void(0)" class="database_op" sort_type="desc" sort_col="ID">ALL (<?=$all_projects_count[0]->pcount;?>)</a></li>
								<li class="<?=((isset($type) && $type == 'featured') ? 'active' : '');?> col_check" colname="featured"><a href="javascript:void(0)" class="search_project_post" colname="featured" sval="1">Featured (<?=$all_featured_projects_count[0]->pcount;?>)</a></li>
								<li class="<?=((isset($type) && $type == 'awardStatus') ? 'active' : '');?> col_check" colname="awardStatus"><a href="javascript:void(0)" class="search_project_post" colname="awardStatus" sval="2">Closed (<?=$all_closed_projects_count[0]->pcount;?>)</a></li>
							</ul>
							...
							<div class="short_search hidden-xs">
						...
						<div class="tab-content-details">
							...
							<?php
								...
								<?php 
									...
									if(empty($sectors) && empty($pposted)){
