...
(function ( $ ) {
	...
	$.fn.bootstrapSwitch = function( options ) {
		...
		return this.each(function(e) {
			...
			var on = $('<button class="btn btn-primary bootstrap-switch-handle-on '+settings.size+disabled+'" style="float: none;display: inline-block;"></button>').html(settings.on).css('margin-right', '0px').appendTo(div);
