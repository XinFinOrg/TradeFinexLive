		...
		<div class="mail_template welcome_mail">
			<div class="main_content">
				...
				<div class="mail_template_body">
					...
					<p>Thank you for registering and acknowledging TERMS at TradeFinex. Your account was created and must be activated before you can use it. This activation link will only valid for the next 3 hours.</p>
