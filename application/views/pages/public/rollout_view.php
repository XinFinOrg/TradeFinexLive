  <!-- Inside Page Roll out Plan -->
  <div class="sub_page_wraper">

<section class="tf-inner-banner">
    <div class="container">
        <h3>Rollout Plan</h3>
        <h4>TradeFinex Rollout Plan.</h4>
    </div>
</section>
...
<section id="rollout-plan" class="section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                        <div class="tf-rollout-plan_block">
                    <div class="row row-eq-height">
                        <div class="col-md-2 pr-0">
                        <div class="tf-rop_number-block text-center">
                            <div class="tf-rop_number">01</div>
                        </div>
                        </div>
                        <div class="col-md-3 pl-0 pr-0">
                        <div class="tf-rop_head-block">
                            <h2>Launch of new website : December 20th</h2>
                        </div>
                        </div>
        ...
        <div class="row mt-15">
            <div class="col-md-12">
                    ...
                    <div class="row row-eq-height">
                        <div class="col-md-2 pr-0">
                        <div class="tf-rop_number-block text-center">
                            <div class="tf-rop_number color2">02</div>
                        </div>
                        </div>
                        <div class="col-md-3 pl-0 pr-0">
                        <div class="tf-rop_head-block">
                            <h2>TradeFinex platform as an aggregator of Trade Finance Assets</h2>
                        </div>
                        </div>
                        <div class="col-md-7 pl-0">
                        <div class="tf-rop_desc-block">
        ...
        <div class="row mt-15">
            <div class="col-md-12">
                    ...
                    <div class="row row-eq-height">
                        <div class="col-md-2 pr-0">
                        <div class="tf-rop_number-block text-center">
                            <div class="tf-rop_number color3">03</div>
                        </div>
                        </div>
                        <div class="col-md-3 pl-0 pr-0">
                        <div class="tf-rop_head-block">
                            <h2>Using XDC as a utility or settlement on TradeFinex</h2>
                        </div>
                        </div>
                        <div class="col-md-7 pl-0">
                        <div class="tf-rop_desc-block">
