...
<section class="tf-inner-banner">
    <div class="container">
        <h3>Supply Chain</h3>
        <h4>Operations Visibility Track and Trace, Chain of Custody.</h4>
    </div>
</section>
        ...
        <section id="supply-chain" class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="section-title text-center">
                            <h2 class="mb-0">Supply Chain - Track & Trace</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tf-supply-chain_block mb-50">
                            <div class="tf-supply-chain-image">
                                <img src="../assets/banner-assets/images/innerpage-images/supply-chain.jpg" class="img-responsive">                            </div>
					...
					<div class="col-md-12">
                        <div class="tf-supply-chain_block left mb-50">
                            <div class="tf-supply-chain-image">
                                <img src="../assets/banner-assets/images/innerpage-images/digital-identity.jpg" class="img-responsive">                            </div>
                            <div class="tf-supply-chain-text">
                    ...
                    <div class="col-md-12">
                        <div class="tf-supply-chain_block mb-50">
                            <div class="tf-supply-chain-image">
                                <img src="../assets/banner-assets/images/innerpage-images/anti-countefeit.jpg" class="img-responsive">                            </div>
                            <div class="tf-supply-chain-text">
                    ...
                    <div class="col-md-12">
                        <div class="tf-supply-chain_block left mb-50">
                            <div class="tf-supply-chain-image">
                                <img src="../assets/banner-assets/images/innerpage-images/anti-diversion.jpg" class="img-responsive">                            </div>
                            <div class="tf-supply-chain-text">
                                <h2>Anti-Diversion</h2>
                                <ul>
                                    <li>Secure asset identities combined with blockchain registrations & chain-of-custody</li>
                                    <li>Track product movements & identify where diversion occurred in the chain & intervene appropriately</li>
                                    <li>Industry - Luxury, Pharmaceuticals, Consumer Electronics, Food & Beverages, Cosmetics</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="tf-supply-chain_block mb-50">
                            <div class="tf-supply-chain-image">
                                <img src="../assets/banner-assets/images/innerpage-images/automation.jpg" class="img-responsive">                            </div>
                            <div class="tf-supply-chain-text">
                                <h2>Automation</h2>
                                <ul>
                    ...
                    <div class="col-lg-12">
                        <div class="tf-supply-chain_block left">
                            <div class="tf-supply-chain-image">
                                <img src="../assets/banner-assets/images/innerpage-images/tokenization.jpg" class="img-responsive">                            </div>
                            <div class="tf-supply-chain-text">
                                <h2>Tokenization</h2>
                                <ul>
				...
				<div class="row">
                    <div class="col-md-12">
						<div class="text-center">
							<a href="<?=base_url();?>publicv/contact" class="btn btn-red text-uppercase mt-10 mb-10">Contact Us</a>
						</div>
					</div>
				</div>			
