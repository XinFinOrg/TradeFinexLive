            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="cnt-block padd-left">
                        ...
                        <p class="mb-15">You can participate in this consortium by joining as either a founding member or an extended member of the consortium. As a member, you will be part of the ecosystem and will contribute to the evolution of the TradeFinex platform. Your contribution in terms of best practices, driving the standardization and working with regulators will help you to influence the future of the industry. Consortium-Led governance makes the platform truly decentralized which is in sync with the core philosophy of blockchain.</p>
                        <p>Participate, co-develop and reap the benefits of the TradeFinex membership.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel-group" id="maccordion">
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">A forum made up of individuals, companies, organizations and governments to contribute towards the evolution of cross border trade and finance practice (using innovative technology) under regulatory framework.</div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">Our community includes Custodians, Banks, Broker/Dealers, Corporates, Exchanges, Clearing Houses, Remittance Companies, Government Bodies, Securities Board and Global Infrastructure Fund.</div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">Consortium is managed and governed by the Members only, However, the entire programme will be administered, monitored and maintained by TradeFinex Tech Pvt Ltd.</div>
                    </div>
                </div>
