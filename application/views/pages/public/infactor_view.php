...
<div class="sub_page_wraper">
    ...
    <!-- Infactor -->
    <section id="infactor" class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6 mb-30">
                    ...
                    <div class="tf-more-features-btn-holder"> <a href="<?=base_url('publicv/invoiceFactoring');?>" class="btn btn-blue text-uppercase">Start POC</a></div>
                </div>
        ...
        <div class="container">
            ...
            <div class="features-carousel-sec">
                <div class="owl-carousel owl-feature">
                    <div class="item"><img src="../assets/banner-assets/images/innerpage-images/infactor-screen-1.png" alt=""></div>
                    <div class="item"><img src="../assets/banner-assets/images/innerpage-images/infactor-screen-2.png" alt=""></div>
                    <div class="item"><img src="../assets/banner-assets/images/innerpage-images/infactor-screen-3.png" alt=""></div>
                    <div class="item"><img src="../assets/banner-assets/images/innerpage-images/infactor-screen-4.png" alt=""></div>
                </div>
            </div>
            <!-- End: Caurosel -->
        </div>
