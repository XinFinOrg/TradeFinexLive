		...
		<div class="tab_group">
			...
			<div class="tab-content">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<div class="form-group">
											<label class="form-label">
												...
												<span class="form-name floating-label">Contact person Mobile Number</span>
											</label>
										</div>
									</div>
									<div class="col-md-4 col-sm-4 col-xs-12">
				...
				<div id="fin_info" class="tab-pane fade">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="form-group">
											<label class="form-label">
												...
												<span id="link_wallet" data-toggle="modal" data-target="#xinfin_usign_in" data-backdrop="static" data-keyboard="false" class="append_icon_image"><a href="javascript:void(0)"></a></span>
											</label>
										</div>
									</div>
									<div class="col-md-4 col-sm-4 col-xs-12">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 accordian_additional_details">
							<button type="button" id="accord_btnb" class="accordion" onclick="trigger_slideb()">Bank Information</button>
					...
					<?php if($ubase_info == 1 && $ucompany_info == 1 && $uprodserv_info == 1 && $ufinance_info == 1){ ?>
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="congratulations_text">
								<p><b>Congratulations.</b> !! You have successfully filled all mandatory registration fields. You may fill remaining information now or start exploring TradeFinex features. Remaining information will become mandatory when you initiate Blockchain based smart contracts. Completing and personalizing your TradeFinex profile can go a long way toward increasing your visibility and marketing power. </p>
							</div> 
						</div>
					</div>
					<?php } ?>
...
<div class="modal fade" id="xinfin_usign_in" role="dialog" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="form-group btn-more">
					<button type="button" id="signin_xinfin_add_wallet_otp" class="btn signin_xinfin_otp" style="display:none;">Add Wallet ID Now</button>
				</div>
			</div>
		</div>
	</div>
