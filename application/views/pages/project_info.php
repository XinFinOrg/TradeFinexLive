			...
			<div class="jumbotron thank_sec" >
			   <div id="page_blank_msg" class="bwhite_content">
					...
					<div class="text-center">
						<h3 class='text-center' style="font-size:17px;line-height:20px;color:#000;padding-left:10px;padding-right:10px;">Oops ! Something Wrong. Click <a href="<?php echo base_url() ?>" >here</a> to go dashboard.</h3>
					</div>
				</div>
			</div>
		</div>
