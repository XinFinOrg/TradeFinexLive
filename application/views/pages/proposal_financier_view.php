                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 hidden-md hidden-lg hidden-sm">
                            <div class="right_part_profile">
                                ...
                                <div class="project_details">
                                    <p>Estimated Budget: <?= $project_listed_info[0]->tfcu_name . '' . number_format($project_listed_info[0]->financing_amount, 0, '', ','); ?></p>
                                    <ul class="location">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <?php
                            $attributes = array('id' => 'form_postf_proposal', 'class' => '', 'method' => 'post', 'role' => 'form');
                            echo form_open_multipart(base_url() . 'project/proposal_financier/', $attributes);
                            ?>
                                    ...
                                    <div class="row sec_row">
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label input_change <?= ($ppriceval > 0 ? 'input-focust' : '') ?>">
                                                    <input type="hidden" id="pcurr" name="pcurr" value="2" />
                                                    <input class="form-input <?= ((trim($ppriceval) <> '' && trim($ppriceval) <> 0) ? 'input-focus' : 'input-focus-notr') ?>" id="ppriceval" name="ppriceval" type="text" data-validation-ignore="-$€" data-validation-allowing="range[0;10], float" data-validation-decimal-separator="." value="<?= ($ppriceval > 0 ? $ppriceval : '') ?>" />
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label input_change <?= ($ppricetax > 0 ? 'input-focust' : '') ?>">
                                                    <input class="form-input <?= ((trim($ppricetax) <> '' && trim($ppricetax) <> 0) ? 'input-focus' : 'input-focus-notr') ?>" id="ppricetax" name="ppricetax" type="text" data-validation-ignore="-$€" data-validation-allowing="range[0;10], float" data-validation-decimal-separator="." value="<?= ($ppricetax > 0 ? $ppricetax : '') ?>" />
                                                    <span class="form-name floating-label">Rate of Interest ( % )<sup>*</sup></span> 
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label <?= (($ptenure > 0 || $project_listed_info[0]->financing_tenure_value > 0) ? 'input-focust' : '') ?>">
                                                    <input class="form-input <?= ((trim($ptenure) <> '' && trim($ptenure) <> 0) ? 'input-focus' : 'input-focus-notr') ?>" id="ptenure" name="ptenure" type="text" required="required" data-validation="number" value="<?= ($ptenure > 0 ? $ptenure : $project_listed_info[0]->financing_tenure_value); ?>" readonly />
                                                    <span class="form-name floating-label">Period of Financing (<?= (($project_listed_info[0]->financing_tenure_ref == 3 || $ptenureu == 3) ? 'Months' : ''); ?>)<sup>*</sup></span> 
                                                    <input type="hidden" id="ptenureu" name="ptenureu" value="<?php echo ($ptenureu > 0 ? $ptenureu : $project_listed_info[0]->financing_tenure_ref) ?>" />
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label <?= ($ppriceemi > 0 ? 'input-focust' : '') ?>">
                                                    <input class="form-input <?= ((trim($ppriceemi) <> '' && trim($ppriceemi) <> 0) ? 'input-focus' : 'input-focus-notr') ?>" id="ppriceemi" name="ppriceemi" type="text" required="required"  autocomplete="" data-required-error="" aria-required="true" data-validation="number" data-validation-ignore="$€" data-validation-allowing="range[0;10], float" data-validation-decimal-separator="." value="<?= ($ppriceemi > 0 ? $ppriceemi : '') ?>" min="0" readonly />
                                                    <span class="form-name floating-label">EMI Amount<sup>*</sup></span> 
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label <?= ($ppricetot > 0 ? 'input-focust' : '') ?>">
                                                    <input class="form-input <?= ((trim($ppricetot) <> '' && trim($ppricetot) <> 0) ? 'input-focus' : 'input-focus-notr') ?>" id="ppricetot" name="ppricetot" type="text" autocomplete=""data-required-error="" aria-required="true" value="<?= ($ppricetot > 0 ? $ppricetot : '') ?>" readonly />
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label <?= ($pvalid > 0 ? 'input-focust' : '') ?>">
                                                    ...
                                                    <input class="form-input <?= ((trim($pvalid) <> '' && trim($pvalid) <> 0) ? 'input-focus' : 'input-focus-notr') ?>" id="pvalid" name="pvalid" type="text" autocomplete="" data-required-error=""  value="<?= ($pvalid > 0 ? $pvalid : '') ?>" />
                                        ...
                                        <div class="col-md-9 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="browse_file custom_fileup">
                                                        ...
                                                        <label id="namefile_1" class="namefile_1 browse_file_name"><!--[jpg,jpeg,png,doc,docx,xls,xlsx,pdf,txt]-->
                                                            <?php
                                                        ...
                                                        &nbsp;
                                            <label id="namefile_2" class="namefile_2 browse_file_name"><!--[jpg,jpeg,png,doc,docx,xls,xlsx,pdf,txt]--></label>&nbsp;
                                                <label id="namefile_3" class="namefile_3 browse_file_name"><!--[jpg,jpeg,png,doc,docx,xls,xlsx,pdf,txt]--></label>
                                                    
                                                        <input id="pdoc_1" name="pdoc[]" class="pdoc" type="file" multiple=''/>
