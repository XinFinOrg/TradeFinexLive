                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="tf-buyer-supplier_form-block">
                            ...
                            <?php
                                $attributes = array('id' => 'borrower_form', 'class' => 'tf-suppliers-form', 'method' => 'post', 'role' => 'form');
                                echo form_open_multipart(base_url().'finxtradez/borrower', $attributes);
                            ?>
			...
			<div class="modal-content">
				...
				<div class="modal-body text-center">
						...
						<form action="<?php echo PAYPAL_URL; ?>" method="post">
                            ...
                            <input type='hidden' name='return' value='<?php echo base_url() ?>finxtradez/borrower'>
