...
{/metadocument}
*/
	var $configuration_file = '../third_party/linkedin-oauth-client/oauth_configuration.json';
...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			case 'LinkedIn2':
				$this->oauth_version = '2.0';
				$this->dialog_url = 'https://www.linkedin.com/uas/oauth2/authorization?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&response_type=code&state={STATE}';
